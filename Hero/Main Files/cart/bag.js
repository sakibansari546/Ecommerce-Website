        ...
        <div class="summary">
            ...
            <hr>
                ...
                <form>
                    <p>SHIPPING</p>
                    <select>
                        <option class="text-muted">Standard-Delivery- &dollar;${StandardDelivery}.00</option>
                    </select>
                    <p>GIVE CODE</p>
                ...
                <div class="row" style="border-top: 1px solid rgba(0,0,0,.1); padding: 2vh 0;">
                    ...
                    <div class="col text-right">&dollar;${finalPrice}</div>
                </div>
...
function generateItemInHTMl(item) {
    return `<div class="row border-top border-bottom" >
                <div class="row main align-items-center">
                    ...
                    <div class="col">&dollar; ${item.price} <span class="close" onclick="removeFormBag(${item.id})">&#10005;</span></div>
                </div>
            </div > `
}
